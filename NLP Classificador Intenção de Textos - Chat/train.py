...
# baseado no original em: https://github.com/dennybritz/cnn-text-classification-tf/blob/master/train.py
...
# tf.flags.DEFINE_string("data_folder", "./dados/originais/", "Data source folder.")
# tf.flags.DEFINE_string("data_folder", "./dados/chat/", "Data source folder.")
tf.flags.DEFINE_string("data_folder", "./dados/raw_beto/", "Data source folder.")
